...
const PostedJobsRow = ({ job, handleDeleteJob }) => {
    ...
    <tr>
      ...
      <td className='px-4 py-4 text-sm whitespace-nowrap'>
        <div className='flex items-center gap-x-6'>
          <button onClick={() => handleDeleteJob(_id)} className='text-gray-500 cursor-pointer transition-colors duration-200   hover:text-red-500 focus:outline-none'>
            <svg
